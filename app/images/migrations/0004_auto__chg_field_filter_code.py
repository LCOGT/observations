...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Filter.code'
        db.alter_column('telescope_filter', 'code', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Filter.code'
        db.alter_column('telescope_filter', 'code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
